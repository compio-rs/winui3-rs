windows_core::imp::define_interface!(ISwapChainPanelNative, ISwapChainPanelNative_Vtbl, 0x63aad0b8_7c24_40ff_85a8_640d944cc325);
...
impl ISwapChainPanelNative {
    ...
    {
        unsafe { (windows_core::Interface::vtable(self).SetSwapChain)(windows_core::Interface::as_raw(self), swapChain.param().abi()).ok() }
    }
}
#[repr(C)]
#[doc(hidden)]
...
pub trait ISwapChainPanelNative_Impl: windows_core::IUnknownImpl {
    fn SetSwapChain(&self, swapChain: windows_core::Ref<'_, windows::Win32::Graphics::Dxgi::IDXGISwapChain>) -> windows_core::Result<()>;
}
    ...
    pub const fn new<Identity: ISwapChainPanelNative_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn SetSwapChain<Identity: ISwapChainPanelNative_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, swapChain: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                ...
                match ISwapChainPanelNative_Impl::SetSwapChain(this, core::mem::transmute_copy(&swapChain)) {
...
impl IWindowNative {
    pub unsafe fn WindowHandle(&self) -> windows_core::Result<windows::Win32::Foundation::HWND> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).WindowHandle)(windows_core::Interface::as_raw(self), &mut result__).ok()?;
            Ok(result__)
        }
    }
}
