...
pub trait ISceneBoundingBox_Impl: windows_core::IUnknownImpl {
    fn Center(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn Extents(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn Max(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn Min(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn Size(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
}
#[cfg(feature = "Foundation_Numerics")]
...
pub struct ISceneBoundingBox_Vtbl {
    ...
    pub Center: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows::Foundation::Numerics::Vector3,
    ) -> windows_core::HRESULT,
...
pub trait ISceneMetallicRoughnessMaterial_Impl: windows_core::IUnknownImpl {
    ...
    fn BaseColorFactor(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector4>;
...
pub struct ISceneMetallicRoughnessMaterial_Vtbl {
    ...
    pub BaseColorFactor: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut windows::Foundation::Numerics::Vector4,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "Foundation_Numerics"))]
...
pub trait ISceneModelTransform_Impl: windows_core::IUnknownImpl {
    ...
    fn RotationAxis(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn SetRotationAxis(
        &self,
        value: &windows::Foundation::Numerics::Vector3,
    ) -> windows_core::Result<()>;
    fn Scale(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn SetScale(&self, value: &windows::Foundation::Numerics::Vector3) -> windows_core::Result<()>;
    fn Translation(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn SetTranslation(
        &self,
        value: &windows::Foundation::Numerics::Vector3,
    ) -> windows_core::Result<()>;
...
pub trait IScenePbrMaterial_Impl: windows_core::IUnknownImpl {
    ...
    fn EmissiveFactor(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows::Foundation::Collections::IVector<SceneComponent>
);
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(
    SceneComponentCollection,
...
unsafe impl windows_core::Interface for SceneComponentCollection {
    type Vtable = < windows::Foundation::Collections:: IVector < SceneComponent > as windows_core::Interface >::Vtable ;
    const IID: windows_core::GUID =
        <windows::Foundation::Collections::IVector<SceneComponent> as windows_core::Interface>::IID;
}
#[cfg(feature = "Foundation_Collections")]
...
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy ! ( SceneMeshMaterialAttributeMap , super:: IAnimationObject , windows::Foundation:: IClosable , windows::Foundation::Collections:: IIterable < windows::Foundation::Collections:: IKeyValuePair < windows_core::HSTRING , SceneAttributeSemantic > > , windows::Foundation::Collections:: IMap < windows_core::HSTRING , SceneAttributeSemantic > , SceneObject , super:: CompositionObject );
#[cfg(feature = "Foundation_Collections")]
impl SceneMeshMaterialAttributeMap {
    ...
    pub fn GetView(
        ...
        windows::Foundation::Collections::IMapView<windows_core::HSTRING, SceneAttributeSemantic>,
    > {
        let this = &windows_core::Interface::cast::<
            windows::Foundation::Collections::IMap<windows_core::HSTRING, SceneAttributeSemantic>,
        >(self)?;
...
impl SceneMetallicRoughnessMaterial {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn BaseColorFactor(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector4> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn EmissiveFactor(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3> {
        let this = &windows_core::Interface::cast::<IScenePbrMaterial>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
windows_core::imp::interface_hierarchy!(
    ...
    windows_core::IUnknown,
    windows_core::IInspectable,
    windows::Foundation::Collections::IVector<SceneNode>
);
#[cfg(feature = "Foundation_Collections")]
windows_core::imp::required_hierarchy!(
    SceneNodeCollection,
...
unsafe impl windows_core::Interface for SceneNodeCollection {
    type Vtable =
        <windows::Foundation::Collections::IVector<SceneNode> as windows_core::Interface>::Vtable;
    const IID: windows_core::GUID =
        <windows::Foundation::Collections::IVector<SceneNode> as windows_core::Interface>::IID;
}
#[cfg(feature = "Foundation_Collections")]
