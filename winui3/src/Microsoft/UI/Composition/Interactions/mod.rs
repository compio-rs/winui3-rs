...
pub trait IInteractionTracker_Impl: windows_core::IUnknownImpl {
    ...
    fn MaxPosition(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn SetMaxPosition(
        &self,
    ...
    fn MinPosition(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn SetMinPosition(
        &self,
        value: &windows::Foundation::Numerics::Vector3,
    ) -> windows_core::Result<()>;
    ...
    fn Position(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn PositionInertiaDecayRate(
        &self,
    ) -> windows_core::Result<windows::Foundation::IReference<windows::Foundation::Numerics::Vector3>>;
...
pub trait IVisualInteractionSource2_Impl: windows_core::IUnknownImpl {
    fn DeltaPosition(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn DeltaScale(&self) -> windows_core::Result<f32>;
    fn Position(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn PositionVelocity(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3>;
    fn Scale(&self) -> windows_core::Result<f32>;
...
impl InteractionTracker {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn MaxPosition(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn MinPosition(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn Position(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl VisualInteractionSource {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn DeltaPosition(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3> {
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn PositionVelocity(&self) -> windows_core::Result<windows::Foundation::Numerics::Vector3> {
        let this = &windows_core::Interface::cast::<IVisualInteractionSource2>(self)?;
        unsafe {
            let mut result__ = core::mem::zeroed();
