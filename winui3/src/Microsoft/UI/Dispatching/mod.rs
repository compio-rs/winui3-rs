...
impl DispatcherQueueController {
    ...
    pub fn ShutdownQueueAsync(&self) -> windows_core::Result<windows::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub trait IDispatcherQueueController_Impl: windows_core::IUnknownImpl {
    ...
    fn ShutdownQueueAsync(&self) -> windows_core::Result<windows::Foundation::IAsyncAction>;
}
