...
windows_core::imp::interface_hierarchy!(DispatcherExitDeferral, windows_core::IUnknown, windows_core::IInspectable);
impl DispatcherExitDeferral {
    pub fn new() -> windows_core::Result<Self> {
        Self::IActivationFactory(|f| f.ActivateInstance::<Self>())
    }
    fn IActivationFactory<R, F: FnOnce(&windows_core::imp::IGenericFactory) -> windows_core::Result<R>>(callback: F) -> windows_core::Result<R> {
        static SHARED: windows_core::imp::FactoryCache<DispatcherExitDeferral, windows_core::imp::IGenericFactory> = windows_core::imp::FactoryCache::new();
...
impl windows_core::RuntimeType for DispatcherExitDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_class::<Self, IDispatcherExitDeferral>();
}
...
impl DispatcherQueue {
    pub fn CreateTimer(&self) -> windows_core::Result<DispatcherQueueTimer> {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).CreateTimer)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
        ...
        P0: windows_core::Param<DispatcherQueueHandler>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TryEnqueue)(windows_core::Interface::as_raw(self), callback.param().abi(), &mut result__).map(|| result__)
        }
    }
        ...
        P1: windows_core::Param<DispatcherQueueHandler>,
    {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).TryEnqueueWithPriority)(windows_core::Interface::as_raw(self), priority, callback.param().abi(), &mut result__).map(|| result__)
        }
    }
    pub fn ShutdownStarting<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<DispatcherQueueShutdownStartingEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let handler = <windows::Foundation::TypedEventHandler<Self, DispatcherQueueShutdownStartingEventArgs>>::new(move |a0, a1| handler(a0, a1));
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).ShutdownStarting)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveShutdownStarting))
        }
    }
    pub fn ShutdownCompleted<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<windows_core::IInspectable>) -> windows_core::Result<()> + Send + 'static,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).ShutdownCompleted)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(self.clone(), token__, windows_core::Interface::vtable(self).RemoveShutdownCompleted))
        }
    }
    ...
    pub fn EnqueueEventLoopExit(&self) -> windows_core::Result<()> {
        ...
        unsafe { (windows_core::Interface::vtable(this).EnqueueEventLoopExit)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn EnsureSystemDispatcherQueue(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IDispatcherQueue3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).EnsureSystemDispatcherQueue)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn RunEventLoop(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IDispatcherQueue3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RunEventLoop)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn RunEventLoopWithOptions<P1>(&self, options: DispatcherRunOptions, deferral: P1) -> windows_core::Result<()>
    where
        P1: windows_core::Param<DispatcherExitDeferral>,
    {
        let this = &windows_core::Interface::cast::<IDispatcherQueue3>(self)?;
        unsafe { (windows_core::Interface::vtable(this).RunEventLoopWithOptions)(windows_core::Interface::as_raw(this), options, deferral.param().abi()).ok() }
    }
    pub fn FrameworkShutdownStarting<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<DispatcherQueueShutdownStartingEventArgs>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = &windows_core::Interface::cast::<IDispatcherQueue3>(self)?;
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(this).FrameworkShutdownStarting)(windows_core::Interface::as_raw(this), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(this.clone(), token__, windows_core::Interface::vtable(this).RemoveFrameworkShutdownStarting))
        }
    }
    pub fn FrameworkShutdownCompleted<F>(&self, handler: F) -> windows_core::Result<windows_core::EventRevoker>
    where
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<windows_core::IInspectable>) -> windows_core::Result<()> + Send + 'static,
    {
        let this = &windows_core::Interface::cast::<IDispatcherQueue3>(self)?;
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(this).FrameworkShutdownCompleted)(windows_core::Interface::as_raw(this), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
            Ok(windows_core::EventRevoker::new(this.clone(), token__, windows_core::Interface::vtable(this).RemoveFrameworkShutdownCompleted))
        }
    }
...
impl DispatcherQueueController {
    ...
    pub fn ShutdownQueueAsync(&self) -> windows_core::Result<windows_future::IAsyncAction> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).ShutdownQueueAsync)(windows_core::Interface::as_raw(self), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        }
    }
    pub fn ShutdownQueue(&self) -> windows_core::Result<()> {
        let this = &windows_core::Interface::cast::<IDispatcherQueueController2>(self)?;
        unsafe { (windows_core::Interface::vtable(this).ShutdownQueue)(windows_core::Interface::as_raw(this)).ok() }
    }
    pub fn CreateOnDedicatedThread() -> windows_core::Result<Self> {
        Self::IDispatcherQueueControllerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateOnDedicatedThread)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
    pub fn CreateOnCurrentThread() -> windows_core::Result<Self> {
        Self::IDispatcherQueueControllerStatics(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).CreateOnCurrentThread)(windows_core::Interface::as_raw(this), &mut result__).and_then(|| windows_core::imp::Type::from_abi(result__))
        })
    }
...
windows_core::imp::define_interface!(DispatcherQueueHandler, DispatcherQueueHandler_Vtbl, 0x2e0872a9_4e29_5f14_b688_fb96d5f9d5f8);
...
struct DispatcherQueueHandlerBox<F: Fn() -> windows_core::Result<()> + Send + 'static>(core::marker::PhantomData<(fn() -> F,)>);
impl<F: Fn() -> windows_core::Result<()> + Send + 'static> DispatcherQueueHandlerBox<F> {
    ...
    unsafe extern "system" fn Invoke(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
        unsafe {
            let this = &mut *(this as *mut *mut core::ffi::c_void as *mut windows_core::imp::DelegateBox<DispatcherQueueHandler, F>);
            (this.invoke)().into()
        }
    }
}
...
impl windows_core::RuntimeType for DispatcherQueuePriority {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"enum(Microsoft.UI.Dispatching.DispatcherQueuePriority;i4)");
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.DispatcherQueuePriority");
}
#[repr(transparent)]
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl DispatcherQueueTimer {
    ...
    pub fn IsRunning(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsRunning)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn IsRepeating(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).IsRepeating)(windows_core::Interface::as_raw(self), &mut result__).map(|| result__)
        }
    }
    pub fn SetIsRepeating(&self, value: bool) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).SetIsRepeating)(windows_core::Interface::as_raw(self), value).ok() }
    }
        ...
        F: Fn(windows_core::Ref<Self>, windows_core::Ref<windows_core::IInspectable>) -> windows_core::Result<()> + Send + 'static,
    {
        ...
        unsafe {
            let mut result__ = core::mem::zeroed();
            let token__ = (windows_core::Interface::vtable(self).Tick)(windows_core::Interface::as_raw(self), windows_core::Interface::as_raw(&handler), &mut result__).map(|| result__)?;
...
impl DispatcherRunOptions {
    ...
    pub const ContinueOnQuit: Self = Self(1);
    pub const QuitOnlyLocalLoop: Self = Self(2);
}
impl windows_core::imp::TypeKind for DispatcherRunOptions {
    type TypeKind = windows_core::imp::CopyType;
}
impl windows_core::RuntimeType for DispatcherRunOptions {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"enum(Microsoft.UI.Dispatching.DispatcherRunOptions;u4)");
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.DispatcherRunOptions");
}
impl DispatcherRunOptions {
...
windows_core::imp::define_interface!(IDispatcherExitDeferral, IDispatcherExitDeferral_Vtbl, 0x910b5aac_3310_563e_8418_f3005579729e);
impl windows_core::RuntimeType for IDispatcherExitDeferral {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherExitDeferral");
}
...
impl IDispatcherExitDeferral_Vtbl {
    pub const fn new<Identity: IDispatcherExitDeferral_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Complete<Identity: IDispatcherExitDeferral_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherExitDeferral_Impl::Complete(this).into()
            }
        }
        Self { base__: windows_core::IInspectable_Vtbl::new::<Identity, IDispatcherExitDeferral, OFFSET>(), Complete: Complete::<Identity, OFFSET> }
    }
...
impl windows_core::RuntimeType for IDispatcherQueue {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueue");
}
...
pub trait IDispatcherQueue_Impl: windows_core::IUnknownImpl {
    ...
    fn TryEnqueue(&self, callback: windows_core::Ref<DispatcherQueueHandler>) -> windows_core::Result<bool>;
    fn TryEnqueueWithPriority(&self, priority: DispatcherQueuePriority, callback: windows_core::Ref<DispatcherQueueHandler>) -> windows_core::Result<bool>;
    fn ShutdownStarting(&self, handler: windows_core::Ref<windows::Foundation::TypedEventHandler<DispatcherQueue, DispatcherQueueShutdownStartingEventArgs>>) -> windows_core::Result<i64>;
    fn RemoveShutdownStarting(&self, token: i64) -> windows_core::Result<()>;
    fn ShutdownCompleted(&self, handler: windows_core::Ref<windows::Foundation::TypedEventHandler<DispatcherQueue, windows_core::IInspectable>>) -> windows_core::Result<i64>;
...
impl IDispatcherQueue_Vtbl {
    pub const fn new<Identity: IDispatcherQueue_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateTimer<Identity: IDispatcherQueue_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TryEnqueue<Identity: IDispatcherQueue_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, callback: *mut core::ffi::c_void, result__: *mut bool) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn TryEnqueueWithPriority<Identity: IDispatcherQueue_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, priority: DispatcherQueuePriority, callback: *mut core::ffi::c_void, result__: *mut bool) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDispatcherQueue_Impl::TryEnqueueWithPriority(this, priority, core::mem::transmute_copy(&callback)) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn ShutdownStarting<Identity: IDispatcherQueue_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handler: *mut core::ffi::c_void, result__: *mut i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDispatcherQueue_Impl::ShutdownStarting(this, core::mem::transmute_copy(&handler)) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn RemoveShutdownStarting<Identity: IDispatcherQueue_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, token: i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueue_Impl::RemoveShutdownStarting(this, token).into()
            }
        }
        unsafe extern "system" fn ShutdownCompleted<Identity: IDispatcherQueue_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handler: *mut core::ffi::c_void, result__: *mut i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDispatcherQueue_Impl::ShutdownCompleted(this, core::mem::transmute_copy(&handler)) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn RemoveShutdownCompleted<Identity: IDispatcherQueue_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, token: i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct IDispatcherQueue_Vtbl {
    ...
    pub ShutdownStarting: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveShutdownStarting: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub ShutdownCompleted: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveShutdownCompleted: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(IDispatcherQueue2, IDispatcherQueue2_Vtbl, 0x0cf48751_f1ac_59b8_ba52_6ce7a1444d6f);
impl windows_core::RuntimeType for IDispatcherQueue2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueue2");
}
...
impl IDispatcherQueue2_Vtbl {
    pub const fn new<Identity: IDispatcherQueue2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn HasThreadAccess<Identity: IDispatcherQueue2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self { base__: windows_core::IInspectable_Vtbl::new::<Identity, IDispatcherQueue2, OFFSET>(), HasThreadAccess: HasThreadAccess::<Identity, OFFSET> }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
...
impl windows_core::RuntimeType for IDispatcherQueue3 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueue3");
}
...
pub trait IDispatcherQueue3_Impl: windows_core::IUnknownImpl {
    ...
    fn RunEventLoopWithOptions(&self, options: DispatcherRunOptions, deferral: windows_core::Ref<DispatcherExitDeferral>) -> windows_core::Result<()>;
    fn FrameworkShutdownStarting(&self, handler: windows_core::Ref<windows::Foundation::TypedEventHandler<DispatcherQueue, DispatcherQueueShutdownStartingEventArgs>>) -> windows_core::Result<i64>;
    fn RemoveFrameworkShutdownStarting(&self, token: i64) -> windows_core::Result<()>;
    fn FrameworkShutdownCompleted(&self, handler: windows_core::Ref<windows::Foundation::TypedEventHandler<DispatcherQueue, windows_core::IInspectable>>) -> windows_core::Result<i64>;
...
impl IDispatcherQueue3_Vtbl {
    pub const fn new<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn EnqueueEventLoopExit<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueue3_Impl::EnqueueEventLoopExit(this).into()
            }
        }
        unsafe extern "system" fn EnsureSystemDispatcherQueue<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueue3_Impl::EnsureSystemDispatcherQueue(this).into()
            }
        }
        unsafe extern "system" fn RunEventLoop<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueue3_Impl::RunEventLoop(this).into()
            }
        }
        unsafe extern "system" fn RunEventLoopWithOptions<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, options: DispatcherRunOptions, deferral: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueue3_Impl::RunEventLoopWithOptions(this, options, core::mem::transmute_copy(&deferral)).into()
            }
        }
        unsafe extern "system" fn FrameworkShutdownStarting<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handler: *mut core::ffi::c_void, result__: *mut i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDispatcherQueue3_Impl::FrameworkShutdownStarting(this, core::mem::transmute_copy(&handler)) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn RemoveFrameworkShutdownStarting<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, token: i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueue3_Impl::RemoveFrameworkShutdownStarting(this, token).into()
            }
        }
        unsafe extern "system" fn FrameworkShutdownCompleted<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handler: *mut core::ffi::c_void, result__: *mut i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDispatcherQueue3_Impl::FrameworkShutdownCompleted(this, core::mem::transmute_copy(&handler)) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn RemoveFrameworkShutdownCompleted<Identity: IDispatcherQueue3_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, token: i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct IDispatcherQueue3_Vtbl {
    ...
    pub EnsureSystemDispatcherQueue: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub RunEventLoop: unsafe extern "system" fn(*mut core::ffi::c_void) -> windows_core::HRESULT,
    pub RunEventLoopWithOptions: unsafe extern "system" fn(*mut core::ffi::c_void, DispatcherRunOptions, *mut core::ffi::c_void) -> windows_core::HRESULT,
    pub FrameworkShutdownStarting: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveFrameworkShutdownStarting: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
    pub FrameworkShutdownCompleted: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
    pub RemoveFrameworkShutdownCompleted: unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(IDispatcherQueueController, IDispatcherQueueController_Vtbl, 0xbce8178d_2183_584c_9e5b_f9366f6ae484);
impl windows_core::RuntimeType for IDispatcherQueueController {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueueController");
}
...
impl IDispatcherQueueController_Vtbl {
    pub const fn new<Identity: IDispatcherQueueController_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DispatcherQueue<Identity: IDispatcherQueueController_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn ShutdownQueueAsync<Identity: IDispatcherQueueController_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IDispatcherQueueController, OFFSET>(),
...
windows_core::imp::define_interface!(IDispatcherQueueController2, IDispatcherQueueController2_Vtbl, 0x4c68ee2a_1cb1_5591_a3a2_9b590b8f8b9a);
impl windows_core::RuntimeType for IDispatcherQueueController2 {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueueController2");
}
...
impl IDispatcherQueueController2_Vtbl {
    pub const fn new<Identity: IDispatcherQueueController2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn ShutdownQueue<Identity: IDispatcherQueueController2_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IDispatcherQueueController2, OFFSET>(),
...
windows_core::imp::define_interface!(IDispatcherQueueControllerStatics, IDispatcherQueueControllerStatics_Vtbl, 0xf18d6145_722b_593d_bcf2_a61e713f0037);
impl windows_core::RuntimeType for IDispatcherQueueControllerStatics {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueueControllerStatics");
}
...
impl IDispatcherQueueControllerStatics_Vtbl {
    pub const fn new<Identity: IDispatcherQueueControllerStatics_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn CreateOnDedicatedThread<Identity: IDispatcherQueueControllerStatics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn CreateOnCurrentThread<Identity: IDispatcherQueueControllerStatics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IDispatcherQueueControllerStatics, OFFSET>(),
...
pub struct IDispatcherQueueControllerStatics_Vtbl {
    ...
    pub CreateOnCurrentThread: unsafe extern "system" fn(*mut core::ffi::c_void, *mut *mut core::ffi::c_void) -> windows_core::HRESULT,
}
windows_core::imp::define_interface!(IDispatcherQueueShutdownStartingEventArgs, IDispatcherQueueShutdownStartingEventArgs_Vtbl, 0x32519be5_072b_5660_a70e_8835c9b8157d);
impl windows_core::RuntimeType for IDispatcherQueueShutdownStartingEventArgs {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueueShutdownStartingEventArgs");
}
...
impl IDispatcherQueueShutdownStartingEventArgs_Vtbl {
    pub const fn new<Identity: IDispatcherQueueShutdownStartingEventArgs_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetDeferral<Identity: IDispatcherQueueShutdownStartingEventArgs_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        Self {
            base__: windows_core::IInspectable_Vtbl::new::<Identity, IDispatcherQueueShutdownStartingEventArgs, OFFSET>(),
...
windows_core::imp::define_interface!(IDispatcherQueueStatics, IDispatcherQueueStatics_Vtbl, 0xcd3382ea_a455_5124_b63a_ca40d34ca23c);
impl windows_core::RuntimeType for IDispatcherQueueStatics {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueueStatics");
}
...
impl IDispatcherQueueStatics_Vtbl {
    pub const fn new<Identity: IDispatcherQueueStatics_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetForCurrentThread<Identity: IDispatcherQueueStatics_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
windows_core::imp::define_interface!(IDispatcherQueueTimer, IDispatcherQueueTimer_Vtbl, 0xad4d63fd_88fe_541f_ac11_bf2dc1ed2ce5);
impl windows_core::RuntimeType for IDispatcherQueueTimer {
    const SIGNATURE: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::for_interface::<Self>();
    const NAME: windows_core::imp::ConstBuffer = windows_core::imp::ConstBuffer::from_slice(b"Microsoft.UI.Dispatching.IDispatcherQueueTimer");
}
...
pub trait IDispatcherQueueTimer_Impl: windows_core::IUnknownImpl {
    fn Interval(&self) -> windows_core::Result<windows_time::TimeSpan>;
    fn SetInterval(&self, value: &windows_time::TimeSpan) -> windows_core::Result<()>;
    ...
    fn Tick(&self, handler: windows_core::Ref<windows::Foundation::TypedEventHandler<DispatcherQueueTimer, windows_core::IInspectable>>) -> windows_core::Result<i64>;
...
impl IDispatcherQueueTimer_Vtbl {
    pub const fn new<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Interval<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut windows_time::TimeSpan) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetInterval<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: windows_time::TimeSpan) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueueTimer_Impl::SetInterval(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn IsRunning<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn IsRepeating<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, result__: *mut bool) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn SetIsRepeating<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, value: bool) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueueTimer_Impl::SetIsRepeating(this, value).into()
            }
        }
        unsafe extern "system" fn Start<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueueTimer_Impl::Start(this).into()
            }
        }
        unsafe extern "system" fn Stop<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IDispatcherQueueTimer_Impl::Stop(this).into()
            }
        }
        unsafe extern "system" fn Tick<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, handler: *mut core::ffi::c_void, result__: *mut i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        unsafe extern "system" fn RemoveTick<Identity: IDispatcherQueueTimer_Impl, const OFFSET: isize>(this: *mut core::ffi::c_void, token: i64) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity = &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub struct IDispatcherQueueTimer_Vtbl {
    ...
    pub Tick: unsafe extern "system" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, *mut i64) -> windows_core::HRESULT,
