...
pub trait IAppWindow_Impl: windows_core::IUnknownImpl {
    ...
    fn MoveAndResizeRelativeToDisplayArea(
        &self,
        rect: &windows::Graphics::RectInt32,
        displayarea: windows_core::Ref<'_, DisplayArea>,
    ) -> windows_core::Result<()>;
...
pub trait IAppWindow3_Impl: windows_core::IUnknownImpl {
    fn AssociateWithDispatcherQueue(
        &self,
        dispatcherQueue: windows_core::Ref<'_, super::Dispatching::DispatcherQueue>,
    ) -> windows_core::Result<()>;
...
impl IDisplayArea_Vtbl {
    pub const fn new<Identity: IDisplayArea_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn DisplayId<Identity: IDisplayArea_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDisplayArea_Impl::DisplayId(this) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        windows_core::HRESULT(0)
                    }
...
pub trait IDisplayAreaStatics2_Impl: windows_core::IUnknownImpl {
    fn GetFromDisplayId(&self, displayId: &super::DisplayId) -> windows_core::Result<DisplayArea>;
}
impl IDisplayAreaStatics2_Vtbl {
    pub const fn new<Identity: IDisplayAreaStatics2_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn GetFromDisplayId<
            Identity: IDisplayAreaStatics2_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IDisplayAreaStatics2_Impl::GetFromDisplayId(
                    this,
        ...
        Self {
            ...
            GetFromDisplayId: GetFromDisplayId::<Identity, OFFSET>,
        }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
