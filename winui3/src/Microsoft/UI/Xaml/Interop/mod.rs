...
impl BindableVectorChangedEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, IBindableObservableVector>,
...
pub trait IBindableObservableVector_Impl: IBindableIterable_Impl + IBindableVector_Impl {
    fn VectorChanged(
        &self,
        handler: windows_core::Ref<'_, BindableVectorChangedEventHandler>,
...
pub trait INotifyCollectionChanged_Impl: windows_core::IUnknownImpl {
    fn CollectionChanged(
        &self,
        handler: windows_core::Ref<'_, NotifyCollectionChangedEventHandler>,
    ) -> windows_core::Result<i64>;
...
pub trait INotifyCollectionChangedEventArgsFactory_Impl: windows_core::IUnknownImpl {
    fn CreateInstanceWithAllParameters(
        ...
        newItems: windows_core::Ref<'_, IBindableVector>,
        oldItems: windows_core::Ref<'_, IBindableVector>,
        newIndex: i32,
        oldIndex: i32,
...
impl NotifyCollectionChangedEventHandler {
    pub fn new<
        F: FnMut(
                windows_core::Ref<'_, windows_core::IInspectable>,
                windows_core::Ref<'_, NotifyCollectionChangedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
