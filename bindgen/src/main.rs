...
const FEATURE_PATCHES: &[(&str, &[&str])] = &[
    ...
    ("UI_Xaml",                        &["UI", "UI_Xaml_Interop", "windows/ApplicationModel_Activation", "windows/ApplicationModel_DataTransfer_DragDrop", "windows/Graphics_Imaging", "windows/UI_Core"]),
